...
pressure_variable_name, concentration_variable_name = "pressure", "concentration"
...
def flora_plant_function(flora, land):
    flora.randomlyPlantTreesInRectangularDomain(initial_plants,tree_species,
                                            land.bounding_box)
...
#simulation
ogs_time_delta_ts = [1e-1, 1e0, 60, 300, 900, 1800, 3600, 3600*2, 3600*4,3600*8]
...
ExecuteStandardModelSetupWithGivenParameters.Run(working_directory, setup_name, 
