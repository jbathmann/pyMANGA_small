...
def main(argv):
  ...
  -k, -kappa <kappa tensor>
    ...
    # -- type:float
    land_length_x, land_length_y, land_length_z = 14, 10, 6
    ...
    land_layers_x, land_layers_y, land_layers_z = 35, 25, 12
    ...
    def ini_concentration_function(point):
        return 0.035 * (1+.01*(+point[0])/land_length_x
                        - .01*(land_length_z * .5
    ...
    if second_tree:
        def flora_plant_function(flora, land):
            ...
            second_tree = Tree.Tree(3+d, 5, flora.land, "Avicennia", 1,
                                    flora.flora_name)
